...
public class ActionCopyexpensesheetline {
     ...
     * 
     */
    public ActionCopyexpensesheetline() {
    }
     ...
     * @param href
     */
    public ActionCopyexpensesheetline(String rel, String href) {
        this.rel = rel;
        this.href = href;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ActionCopyexpensesheetline) == false) {
            return false;
        }
        ActionCopyexpensesheetline rhs = ((ActionCopyexpensesheetline) other);
