...
public class DataKeyFavoriteJobfavorite {
     ...
     * 
     */
    public DataKeyFavoriteJobfavorite() {
    }
     ...
     * @param rel
     */
    public DataKeyFavoriteJobfavorite(String rel, String template) {
        this.rel = rel;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DataKeyFavoriteJobfavorite) == false) {
            return false;
        }
        DataKeyFavoriteJobfavorite rhs = ((DataKeyFavoriteJobfavorite) other);
