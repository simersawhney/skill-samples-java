...
public class ActionEmailonaction_ {
     ...
     * @param href
     */
    public ActionEmailonaction_(String rel, String href) {
        this.rel = rel;
        this.href = href;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ActionEmailonaction_) == false) {
            return false;
        }
        ActionEmailonaction_ rhs = ((ActionEmailonaction_) other);
