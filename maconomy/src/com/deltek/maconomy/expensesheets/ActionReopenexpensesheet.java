...
public class ActionReopenexpensesheet {
     ...
     * 
     */
    public ActionReopenexpensesheet() {
    }
     ...
     * @param href
     */
    public ActionReopenexpensesheet(String rel, String href) {
        this.rel = rel;
        this.href = href;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ActionReopenexpensesheet) == false) {
            return false;
        }
        ActionReopenexpensesheet rhs = ((ActionReopenexpensesheet) other);
