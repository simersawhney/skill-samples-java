...
public class ActionCreate_ {
     ...
     * @param href
     */
    public ActionCreate_(String rel, String href) {
        this.rel = rel;
        this.href = href;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ActionCreate_) == false) {
            return false;
        }
        ActionCreate_ rhs = ((ActionCreate_) other);
