...
public class ActionExportdataset {
     ...
     * @param href
     */
    public ActionExportdataset(String rel, String href) {
        this.rel = rel;
        this.href = href;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ActionExportdataset) == false) {
            return false;
        }
        ActionExportdataset rhs = ((ActionExportdataset) other);
