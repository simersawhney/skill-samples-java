...
public class DataKeyInstancekeyNoteheader {
     ...
     * 
     */
    public DataKeyInstancekeyNoteheader() {
    }
     ...
     * @param rel
     */
    public DataKeyInstancekeyNoteheader(String rel, String template) {
        this.rel = rel;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DataKeyInstancekeyNoteheader) == false) {
            return false;
        }
        DataKeyInstancekeyNoteheader rhs = ((DataKeyInstancekeyNoteheader) other);
