...
public class DataKeyJobnumberJobheader {
     ...
     * 
     */
    public DataKeyJobnumberJobheader() {
    }
     ...
     * @param rel
     */
    public DataKeyJobnumberJobheader(String rel, String template) {
        this.rel = rel;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DataKeyJobnumberJobheader) == false) {
            return false;
        }
        DataKeyJobnumberJobheader rhs = ((DataKeyJobnumberJobheader) other);
