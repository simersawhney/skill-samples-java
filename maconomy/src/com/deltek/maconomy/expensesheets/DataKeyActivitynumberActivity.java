...
public class DataKeyActivitynumberActivity {
     ...
     * 
     */
    public DataKeyActivitynumberActivity() {
    }
     ...
     * @param rel
     */
    public DataKeyActivitynumberActivity(String rel, String template) {
        this.rel = rel;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DataKeyActivitynumberActivity) == false) {
            return false;
        }
        DataKeyActivitynumberActivity rhs = ((DataKeyActivitynumberActivity) other);
