...
public class DataKeyNotenumberNoteheader {
     ...
     * 
     */
    public DataKeyNotenumberNoteheader() {
    }
     ...
     * @param rel
     */
    public DataKeyNotenumberNoteheader(String rel, String template) {
        this.rel = rel;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DataKeyNotenumberNoteheader) == false) {
            return false;
        }
        DataKeyNotenumberNoteheader rhs = ((DataKeyNotenumberNoteheader) other);
