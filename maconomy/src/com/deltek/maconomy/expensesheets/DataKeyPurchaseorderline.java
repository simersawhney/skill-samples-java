...
public class DataKeyPurchaseorderline {
     ...
     * 
     */
    public DataKeyPurchaseorderline() {
    }
     ...
     * @param rel
     */
    public DataKeyPurchaseorderline(String rel, String template) {
        this.rel = rel;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DataKeyPurchaseorderline) == false) {
            return false;
        }
        DataKeyPurchaseorderline rhs = ((DataKeyPurchaseorderline) other);
