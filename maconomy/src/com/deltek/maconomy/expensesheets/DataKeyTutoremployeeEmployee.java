...
public class DataKeyTutoremployeeEmployee {
     ...
     * 
     */
    public DataKeyTutoremployeeEmployee() {
    }
     ...
     * @param rel
     */
    public DataKeyTutoremployeeEmployee(String rel, String template) {
        this.rel = rel;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DataKeyTutoremployeeEmployee) == false) {
            return false;
        }
        DataKeyTutoremployeeEmployee rhs = ((DataKeyTutoremployeeEmployee) other);
