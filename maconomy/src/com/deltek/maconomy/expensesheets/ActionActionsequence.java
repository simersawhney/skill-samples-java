...
public class ActionActionsequence {
     ...
     * @param href
     */
    public ActionActionsequence(String rel, String href) {
        this.rel = rel;
        this.href = href;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ActionActionsequence) == false) {
            return false;
        }
        ActionActionsequence rhs = ((ActionActionsequence) other);
