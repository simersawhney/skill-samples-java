...
public class ActionDuplicateexpensesheet {
     ...
     * 
     */
    public ActionDuplicateexpensesheet() {
    }
     ...
     * @param href
     */
    public ActionDuplicateexpensesheet(String rel, String href) {
        this.rel = rel;
        this.href = href;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ActionDuplicateexpensesheet) == false) {
            return false;
        }
        ActionDuplicateexpensesheet rhs = ((ActionDuplicateexpensesheet) other);
