...
public class DataKeyLocationnameLocation {
     ...
     * 
     */
    public DataKeyLocationnameLocation() {
    }
     ...
     * @param rel
     */
    public DataKeyLocationnameLocation(String rel, String template) {
        this.rel = rel;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DataKeyLocationnameLocation) == false) {
            return false;
        }
        DataKeyLocationnameLocation rhs = ((DataKeyLocationnameLocation) other);
