...
public class DataKeyCountryCountry {
     ...
     * @param rel
     */
    public DataKeyCountryCountry(String rel, String template) {
        this.rel = rel;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DataKeyCountryCountry) == false) {
            return false;
        }
        DataKeyCountryCountry rhs = ((DataKeyCountryCountry) other);
