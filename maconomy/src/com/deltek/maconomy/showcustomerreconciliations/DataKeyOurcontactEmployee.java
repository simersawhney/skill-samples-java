...
public class DataKeyOurcontactEmployee {
     ...
     * 
     */
    public DataKeyOurcontactEmployee() {
    }
     ...
     * @param rel
     */
    public DataKeyOurcontactEmployee(String rel, String template) {
        this.rel = rel;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DataKeyOurcontactEmployee) == false) {
            return false;
        }
        DataKeyOurcontactEmployee rhs = ((DataKeyOurcontactEmployee) other);
