...
public class Meta_ {
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(paneName).append(rowCount).append(rowOffset).append(additionalProperties).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(paneName, rhs.paneName).append(rowCount, rhs.rowCount).append(rowOffset, rhs.rowOffset).append(additionalProperties, rhs.additionalProperties).isEquals();
    }
