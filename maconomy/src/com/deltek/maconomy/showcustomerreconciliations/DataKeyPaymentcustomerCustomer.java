...
public class DataKeyPaymentcustomerCustomer {
     ...
     * 
     */
    public DataKeyPaymentcustomerCustomer() {
    }
     ...
     * @param rel
     */
    public DataKeyPaymentcustomerCustomer(String rel, String template) {
        this.rel = rel;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DataKeyPaymentcustomerCustomer) == false) {
            return false;
        }
        DataKeyPaymentcustomerCustomer rhs = ((DataKeyPaymentcustomerCustomer) other);
