...
public class DataKeyPostaldistrict1 {
     ...
     * @param rel
     */
    public DataKeyPostaldistrict1(String rel, String template) {
        this.rel = rel;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DataKeyPostaldistrict1) == false) {
            return false;
        }
        DataKeyPostaldistrict1 rhs = ((DataKeyPostaldistrict1) other);
