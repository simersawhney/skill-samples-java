...
public class DataKeyCustomernumberCustomer {
     ...
     * 
     */
    public DataKeyCustomernumberCustomer() {
    }
     ...
     * @param rel
     */
    public DataKeyCustomernumberCustomer(String rel, String template) {
        this.rel = rel;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DataKeyCustomernumberCustomer) == false) {
            return false;
        }
        DataKeyCustomernumberCustomer rhs = ((DataKeyCustomernumberCustomer) other);
