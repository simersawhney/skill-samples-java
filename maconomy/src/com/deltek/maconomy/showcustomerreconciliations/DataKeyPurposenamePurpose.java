...
public class DataKeyPurposenamePurpose {
     ...
     * 
     */
    public DataKeyPurposenamePurpose() {
    }
     ...
     * @param rel
     */
    public DataKeyPurposenamePurpose(String rel, String template) {
        this.rel = rel;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DataKeyPurposenamePurpose) == false) {
            return false;
        }
        DataKeyPurposenamePurpose rhs = ((DataKeyPurposenamePurpose) other);
