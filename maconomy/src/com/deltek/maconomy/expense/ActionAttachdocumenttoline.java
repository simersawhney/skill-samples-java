...
public class ActionAttachdocumenttoline {
     ...
     * 
     */
    public ActionAttachdocumenttoline() {
    }
     ...
     * @param href
     */
    public ActionAttachdocumenttoline(String href, String rel) {
        super();
        this.href = href;
        this.rel = rel;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ActionAttachdocumenttoline) == false) {
            return false;
        }
        ActionAttachdocumenttoline rhs = ((ActionAttachdocumenttoline) other);
