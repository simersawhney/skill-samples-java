...
public class ActionAttachdocument {
     ...
     * @param href
     */
    public ActionAttachdocument(String href, String rel) {
        super();
        this.href = href;
        this.rel = rel;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ActionAttachdocument) == false) {
            return false;
        }
        ActionAttachdocument rhs = ((ActionAttachdocument) other);
