...
public class ActionInsert_ {
     ...
     * @param href
     */
    public ActionInsert_(String href, String rel) {
        super();
        this.href = href;
        this.rel = rel;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ActionInsert_) == false) {
            return false;
        }
        ActionInsert_ rhs = ((ActionInsert_) other);
