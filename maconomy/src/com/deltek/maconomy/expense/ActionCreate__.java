...
public class ActionCreate__ {
     ...
     * @param href
     */
    public ActionCreate__(String href, String rel) {
        super();
        this.href = href;
        this.rel = rel;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ActionCreate__) == false) {
            return false;
        }
        ActionCreate__ rhs = ((ActionCreate__) other);
