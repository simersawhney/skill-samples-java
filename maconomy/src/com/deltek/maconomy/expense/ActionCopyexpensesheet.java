...
public class ActionCopyexpensesheet {
     ...
     * @param href
     */
    public ActionCopyexpensesheet(String href, String rel) {
        super();
        this.href = href;
        this.rel = rel;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ActionCopyexpensesheet) == false) {
            return false;
        }
        ActionCopyexpensesheet rhs = ((ActionCopyexpensesheet) other);
