...
public class ActionSubmitexpensesheet {
     ...
     * 
     */
    public ActionSubmitexpensesheet() {
    }
     ...
     * @param href
     */
    public ActionSubmitexpensesheet(String href, String rel) {
        super();
        this.href = href;
        this.rel = rel;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ActionSubmitexpensesheet) == false) {
            return false;
        }
        ActionSubmitexpensesheet rhs = ((ActionSubmitexpensesheet) other);
