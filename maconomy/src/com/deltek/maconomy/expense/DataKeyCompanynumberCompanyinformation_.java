...
public class DataKeyCompanynumberCompanyinformation_ {
     ...
     * 
     */
    public DataKeyCompanynumberCompanyinformation_() {
    }
     ...
     * @param rel
     */
    public DataKeyCompanynumberCompanyinformation_(String template, String rel) {
        super();
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DataKeyCompanynumberCompanyinformation_) == false) {
            return false;
        }
        DataKeyCompanynumberCompanyinformation_ rhs = ((DataKeyCompanynumberCompanyinformation_) other);
