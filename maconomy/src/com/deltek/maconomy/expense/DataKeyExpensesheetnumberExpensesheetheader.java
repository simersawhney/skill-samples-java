...
public class DataKeyExpensesheetnumberExpensesheetheader {
     ...
     * 
     */
    public DataKeyExpensesheetnumberExpensesheetheader() {
    }
     ...
     * @param rel
     */
    public DataKeyExpensesheetnumberExpensesheetheader(String template, String rel) {
        super();
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DataKeyExpensesheetnumberExpensesheetheader) == false) {
            return false;
        }
        DataKeyExpensesheetnumberExpensesheetheader rhs = ((DataKeyExpensesheetnumberExpensesheetheader) other);
