...
public class ActionRunreport_ {
     ...
     * @param href
     */
    public ActionRunreport_(String href, String rel) {
        super();
        this.href = href;
        this.rel = rel;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ActionRunreport_) == false) {
            return false;
        }
        ActionRunreport_ rhs = ((ActionRunreport_) other);
