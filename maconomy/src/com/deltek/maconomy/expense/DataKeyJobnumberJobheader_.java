...
public class DataKeyJobnumberJobheader_ {
     ...
     * 
     */
    public DataKeyJobnumberJobheader_() {
    }
     ...
     * @param rel
     */
    public DataKeyJobnumberJobheader_(String template, String rel) {
        super();
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DataKeyJobnumberJobheader_) == false) {
            return false;
        }
        DataKeyJobnumberJobheader_ rhs = ((DataKeyJobnumberJobheader_) other);
