...
public class ActionDelete_ {
     ...
     * @param href
     */
    public ActionDelete_(String href, String rel) {
        super();
        this.href = href;
        this.rel = rel;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ActionDelete_) == false) {
            return false;
        }
        ActionDelete_ rhs = ((ActionDelete_) other);
