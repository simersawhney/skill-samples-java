...
public class ActionInsert__ {
     ...
     * @param href
     */
    public ActionInsert__(String href, String rel) {
        super();
        this.href = href;
        this.rel = rel;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ActionInsert__) == false) {
            return false;
        }
        ActionInsert__ rhs = ((ActionInsert__) other);
