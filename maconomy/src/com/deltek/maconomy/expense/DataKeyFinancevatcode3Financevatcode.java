...
public class DataKeyFinancevatcode3Financevatcode {
     ...
     * 
     */
    public DataKeyFinancevatcode3Financevatcode() {
    }
     ...
     * @param rel
     */
    public DataKeyFinancevatcode3Financevatcode(String template, String rel) {
        super();
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DataKeyFinancevatcode3Financevatcode) == false) {
            return false;
        }
        DataKeyFinancevatcode3Financevatcode rhs = ((DataKeyFinancevatcode3Financevatcode) other);
