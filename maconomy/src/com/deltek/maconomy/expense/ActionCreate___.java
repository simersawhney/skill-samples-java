...
public class ActionCreate___ {
     ...
     * @param href
     */
    public ActionCreate___(String href, String rel) {
        super();
        this.href = href;
        this.rel = rel;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ActionCreate___) == false) {
            return false;
        }
        ActionCreate___ rhs = ((ActionCreate___) other);
