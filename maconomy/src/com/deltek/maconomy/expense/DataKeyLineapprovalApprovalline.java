...
public class DataKeyLineapprovalApprovalline {
     ...
     * 
     */
    public DataKeyLineapprovalApprovalline() {
    }
     ...
     * @param rel
     */
    public DataKeyLineapprovalApprovalline(String template, String rel) {
        super();
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DataKeyLineapprovalApprovalline) == false) {
            return false;
        }
        DataKeyLineapprovalApprovalline rhs = ((DataKeyLineapprovalApprovalline) other);
