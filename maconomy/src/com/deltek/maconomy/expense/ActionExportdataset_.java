...
public class ActionExportdataset_ {
     ...
     * @param href
     */
    public ActionExportdataset_(String href, String rel) {
        super();
        this.href = href;
        this.rel = rel;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ActionExportdataset_) == false) {
            return false;
        }
        ActionExportdataset_ rhs = ((ActionExportdataset_) other);
