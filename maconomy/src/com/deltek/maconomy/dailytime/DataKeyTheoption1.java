...
public class DataKeyTheoption1 {
     ...
     * @param rel
     */
    public DataKeyTheoption1(String template, String rel) {
        super();
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DataKeyTheoption1) == false) {
            return false;
        }
        DataKeyTheoption1 rhs = ((DataKeyTheoption1) other);
