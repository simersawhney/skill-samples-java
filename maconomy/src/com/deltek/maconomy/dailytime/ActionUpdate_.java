...
public class ActionUpdate_ {
     ...
     * @param href
     */
    public ActionUpdate_(String href, String rel) {
        super();
        this.href = href;
        this.rel = rel;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ActionUpdate_) == false) {
            return false;
        }
        ActionUpdate_ rhs = ((ActionUpdate_) other);
