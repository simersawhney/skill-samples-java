...
public class ActionActionsequence_ {
     ...
     * @param href
     */
    public ActionActionsequence_(String href, String rel) {
        super();
        this.href = href;
        this.rel = rel;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ActionActionsequence_) == false) {
            return false;
        }
        ActionActionsequence_ rhs = ((ActionActionsequence_) other);
