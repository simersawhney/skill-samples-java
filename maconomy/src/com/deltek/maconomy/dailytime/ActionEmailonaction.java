...
public class ActionEmailonaction {
     ...
     * @param href
     */
    public ActionEmailonaction(String href, String rel) {
        super();
        this.href = href;
        this.rel = rel;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ActionEmailonaction) == false) {
            return false;
        }
        ActionEmailonaction rhs = ((ActionEmailonaction) other);
