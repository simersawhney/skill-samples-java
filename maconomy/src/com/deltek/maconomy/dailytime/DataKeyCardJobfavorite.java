...
public class DataKeyCardJobfavorite {
     ...
     * @param rel
     */
    public DataKeyCardJobfavorite(String template, String rel) {
        super();
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DataKeyCardJobfavorite) == false) {
            return false;
        }
        DataKeyCardJobfavorite rhs = ((DataKeyCardJobfavorite) other);
