...
public class DataKeyDailytimesheetheader {
     ...
     * 
     */
    public DataKeyDailytimesheetheader() {
    }
     ...
     * @param rel
     */
    public DataKeyDailytimesheetheader(String rel, String template) {
        this.rel = rel;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DataKeyDailytimesheetheader) == false) {
            return false;
        }
        DataKeyDailytimesheetheader rhs = ((DataKeyDailytimesheetheader) other);
