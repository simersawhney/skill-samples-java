...
public class DataKeyCardDefaultjobheader {
     ...
     * 
     */
    public DataKeyCardDefaultjobheader() {
    }
     ...
     * @param rel
     */
    public DataKeyCardDefaultjobheader(String rel, String template) {
        this.rel = rel;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DataKeyCardDefaultjobheader) == false) {
            return false;
        }
        DataKeyCardDefaultjobheader rhs = ((DataKeyCardDefaultjobheader) other);
