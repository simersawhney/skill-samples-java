...
public class DataKeyCardDailycheckinheader {
     ...
     * 
     */
    public DataKeyCardDailycheckinheader() {
    }
     ...
     * @param rel
     */
    public DataKeyCardDailycheckinheader(String rel, String template) {
        this.rel = rel;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DataKeyCardDailycheckinheader) == false) {
            return false;
        }
        DataKeyCardDailycheckinheader rhs = ((DataKeyCardDailycheckinheader) other);
