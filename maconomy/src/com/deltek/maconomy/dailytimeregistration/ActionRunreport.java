...
public class ActionRunreport {
     ...
     * @param href
     */
    public ActionRunreport(String rel, String href) {
        this.rel = rel;
        this.href = href;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ActionRunreport) == false) {
            return false;
        }
        ActionRunreport rhs = ((ActionRunreport) other);
