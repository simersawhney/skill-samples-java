...
public class ActionCreateconversation {
     ...
     * 
     */
    public ActionCreateconversation() {
    }
     ...
     * @param href
     */
    public ActionCreateconversation(String rel, String href) {
        this.rel = rel;
        this.href = href;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ActionCreateconversation) == false) {
            return false;
        }
        ActionCreateconversation rhs = ((ActionCreateconversation) other);
