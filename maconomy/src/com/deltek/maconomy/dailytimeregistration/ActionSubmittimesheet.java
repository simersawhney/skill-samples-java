...
public class ActionSubmittimesheet {
     ...
     * @param href
     */
    public ActionSubmittimesheet(String rel, String href) {
        this.rel = rel;
        this.href = href;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ActionSubmittimesheet) == false) {
            return false;
        }
        ActionSubmittimesheet rhs = ((ActionSubmittimesheet) other);
