...
public class DataKeyTheoption5 {
     ...
     * @param rel
     */
    public DataKeyTheoption5(String rel, String template) {
        this.rel = rel;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DataKeyTheoption5) == false) {
            return false;
        }
        DataKeyTheoption5 rhs = ((DataKeyTheoption5) other);
