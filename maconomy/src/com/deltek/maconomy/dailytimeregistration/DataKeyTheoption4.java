...
public class DataKeyTheoption4 {
     ...
     * @param rel
     */
    public DataKeyTheoption4(String rel, String template) {
        this.rel = rel;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DataKeyTheoption4) == false) {
            return false;
        }
        DataKeyTheoption4 rhs = ((DataKeyTheoption4) other);
