...
public class ActionTransfertime {
     ...
     * @param href
     */
    public ActionTransfertime(String rel, String href) {
        this.rel = rel;
        this.href = href;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ActionTransfertime) == false) {
            return false;
        }
        ActionTransfertime rhs = ((ActionTransfertime) other);
