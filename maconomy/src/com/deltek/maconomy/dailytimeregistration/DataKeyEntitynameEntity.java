...
public class DataKeyEntitynameEntity {
     ...
     * 
     */
    public DataKeyEntitynameEntity() {
    }
     ...
     * @param rel
     */
    public DataKeyEntitynameEntity(String rel, String template) {
        this.rel = rel;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DataKeyEntitynameEntity) == false) {
            return false;
        }
        DataKeyEntitynameEntity rhs = ((DataKeyEntitynameEntity) other);
