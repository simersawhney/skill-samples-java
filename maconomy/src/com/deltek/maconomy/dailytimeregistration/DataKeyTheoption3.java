...
public class DataKeyTheoption3 {
     ...
     * @param rel
     */
    public DataKeyTheoption3(String rel, String template) {
        this.rel = rel;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DataKeyTheoption3) == false) {
            return false;
        }
        DataKeyTheoption3 rhs = ((DataKeyTheoption3) other);
