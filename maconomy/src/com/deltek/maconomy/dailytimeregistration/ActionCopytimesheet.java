...
public class ActionCopytimesheet {
     ...
     * @param href
     */
    public ActionCopytimesheet(String rel, String href) {
        this.rel = rel;
        this.href = href;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ActionCopytimesheet) == false) {
            return false;
        }
        ActionCopytimesheet rhs = ((ActionCopytimesheet) other);
