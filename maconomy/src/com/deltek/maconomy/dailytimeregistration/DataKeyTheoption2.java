...
public class DataKeyTheoption2 {
     ...
     * @param rel
     */
    public DataKeyTheoption2(String rel, String template) {
        this.rel = rel;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DataKeyTheoption2) == false) {
            return false;
        }
        DataKeyTheoption2 rhs = ((DataKeyTheoption2) other);
