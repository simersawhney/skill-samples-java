...
public class ActionStarttimer {
     ...
     * @param href
     */
    public ActionStarttimer(String rel, String href) {
        this.rel = rel;
        this.href = href;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ActionStarttimer) == false) {
            return false;
        }
        ActionStarttimer rhs = ((ActionStarttimer) other);
