...
public class DataKeyAbsencetypeAbsencetype {
     ...
     * 
     */
    public DataKeyAbsencetypeAbsencetype() {
    }
     ...
     * @param rel
     */
    public DataKeyAbsencetypeAbsencetype(String rel, String template) {
        this.rel = rel;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DataKeyAbsencetypeAbsencetype) == false) {
            return false;
        }
        DataKeyAbsencetypeAbsencetype rhs = ((DataKeyAbsencetypeAbsencetype) other);
