...
public class ActionPrinttimesheet {
     ...
     * @param href
     */
    public ActionPrinttimesheet(String rel, String href) {
        this.rel = rel;
        this.href = href;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ActionPrinttimesheet) == false) {
            return false;
        }
        ActionPrinttimesheet rhs = ((ActionPrinttimesheet) other);
