...
public class DataKeyParentcustomerCustomer {
     ...
     * 
     */
    public DataKeyParentcustomerCustomer() {
    }
     ...
     * @param rel
     */
    public DataKeyParentcustomerCustomer(String template, String rel) {
        super();
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DataKeyParentcustomerCustomer) == false) {
            return false;
        }
        DataKeyParentcustomerCustomer rhs = ((DataKeyParentcustomerCustomer) other);
