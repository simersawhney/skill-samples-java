...
public class DataKeyCreditgeneraljournalCustomerpayment {
     ...
     * 
     */
    public DataKeyCreditgeneraljournalCustomerpayment() {
    }
     ...
     * @param rel
     */
    public DataKeyCreditgeneraljournalCustomerpayment(String template, String rel) {
        super();
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DataKeyCreditgeneraljournalCustomerpayment) == false) {
            return false;
        }
        DataKeyCreditgeneraljournalCustomerpayment rhs = ((DataKeyCreditgeneraljournalCustomerpayment) other);
