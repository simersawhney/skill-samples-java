...
public class DataKeyAccountstatement {
     ...
     * 
     */
    public DataKeyAccountstatement() {
    }
     ...
     * @param rel
     */
    public DataKeyAccountstatement(String template, String rel) {
        super();
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DataKeyAccountstatement) == false) {
            return false;
        }
        DataKeyAccountstatement rhs = ((DataKeyAccountstatement) other);
