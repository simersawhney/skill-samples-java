...
public class DataKeyCompanycustomerentitynameEntity {
     ...
     * 
     */
    public DataKeyCompanycustomerentitynameEntity() {
    }
     ...
     * @param rel
     */
    public DataKeyCompanycustomerentitynameEntity(String template, String rel) {
        super();
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DataKeyCompanycustomerentitynameEntity) == false) {
            return false;
        }
        DataKeyCompanycustomerentitynameEntity rhs = ((DataKeyCompanycustomerentitynameEntity) other);
