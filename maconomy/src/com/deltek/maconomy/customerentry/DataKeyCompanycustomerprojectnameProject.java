...
public class DataKeyCompanycustomerprojectnameProject {
     ...
     * 
     */
    public DataKeyCompanycustomerprojectnameProject() {
    }
     ...
     * @param rel
     */
    public DataKeyCompanycustomerprojectnameProject(String template, String rel) {
        super();
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DataKeyCompanycustomerprojectnameProject) == false) {
            return false;
        }
        DataKeyCompanycustomerprojectnameProject rhs = ((DataKeyCompanycustomerprojectnameProject) other);
