...
public class DataKeyCompanycustomer {
     ...
     * @param rel
     */
    public DataKeyCompanycustomer(String template, String rel) {
        super();
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DataKeyCompanycustomer) == false) {
            return false;
        }
        DataKeyCompanycustomer rhs = ((DataKeyCompanycustomer) other);
