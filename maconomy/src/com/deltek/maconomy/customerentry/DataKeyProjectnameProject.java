...
public class DataKeyProjectnameProject {
     ...
     * 
     */
    public DataKeyProjectnameProject() {
    }
     ...
     * @param rel
     */
    public DataKeyProjectnameProject(String template, String rel) {
        super();
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DataKeyProjectnameProject) == false) {
            return false;
        }
        DataKeyProjectnameProject rhs = ((DataKeyProjectnameProject) other);
