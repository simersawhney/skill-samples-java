...
public class DataKeyDocumentarchivenumberDocumentarchiveheader {
     ...
     * 
     */
    public DataKeyDocumentarchivenumberDocumentarchiveheader() {
    }
     ...
     * @param rel
     */
    public DataKeyDocumentarchivenumberDocumentarchiveheader(String template, String rel) {
        super();
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DataKeyDocumentarchivenumberDocumentarchiveheader) == false) {
            return false;
        }
        DataKeyDocumentarchivenumberDocumentarchiveheader rhs = ((DataKeyDocumentarchivenumberDocumentarchiveheader) other);
