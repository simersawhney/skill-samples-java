...
public class DataKeyHolidaycalendarnameHolidaycalendarheader {
     ...
     * 
     */
    public DataKeyHolidaycalendarnameHolidaycalendarheader() {
    }
     ...
     * @param rel
     */
    public DataKeyHolidaycalendarnameHolidaycalendarheader(String template, String rel) {
        super();
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DataKeyHolidaycalendarnameHolidaycalendarheader) == false) {
            return false;
        }
        DataKeyHolidaycalendarnameHolidaycalendarheader rhs = ((DataKeyHolidaycalendarnameHolidaycalendarheader) other);
