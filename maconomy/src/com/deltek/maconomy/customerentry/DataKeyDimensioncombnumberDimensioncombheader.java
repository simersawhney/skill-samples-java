...
public class DataKeyDimensioncombnumberDimensioncombheader {
     ...
     * 
     */
    public DataKeyDimensioncombnumberDimensioncombheader() {
    }
     ...
     * @param rel
     */
    public DataKeyDimensioncombnumberDimensioncombheader(String template, String rel) {
        super();
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DataKeyDimensioncombnumberDimensioncombheader) == false) {
            return false;
        }
        DataKeyDimensioncombnumberDimensioncombheader rhs = ((DataKeyDimensioncombnumberDimensioncombheader) other);
