...
public class DataKeyAccountstatementcustomerCustomer {
     ...
     * 
     */
    public DataKeyAccountstatementcustomerCustomer() {
    }
     ...
     * @param rel
     */
    public DataKeyAccountstatementcustomerCustomer(String template, String rel) {
        super();
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DataKeyAccountstatementcustomerCustomer) == false) {
            return false;
        }
        DataKeyAccountstatementcustomerCustomer rhs = ((DataKeyAccountstatementcustomerCustomer) other);
