...
public class DataKeyJournalnumberJournal {
     ...
     * 
     */
    public DataKeyJournalnumberJournal() {
    }
     ...
     * @param rel
     */
    public DataKeyJournalnumberJournal(String template, String rel) {
        super();
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DataKeyJournalnumberJournal) == false) {
            return false;
        }
        DataKeyJournalnumberJournal rhs = ((DataKeyJournalnumberJournal) other);
